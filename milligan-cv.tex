...
\begin{minipage}[t]{2.95in}
 ...
 \href{http://uwaterloo.ca/history}{Department of History} \\ HH Building, room 114 \\ University of Waterloo \\ \vspace{-0.05in} Waterloo ON, \textsc{nc} N2L 2C8.}  
...
\noindent\emph{Peer-reviewed Technical Contributions \vspace{0.05in}}
% \renewcommand{\labelenumi}{\textsc{c}\theenumi.}
% \begin{revnumerate}
...
\ind Social Sciences and Humanities Research Council, Insight Development Grant (``An Infinite Archive? Developing HistoryCrawler to Explore the Internet Archive as a Historical Resource''). \$74,952 CAD. Principal Investigator: \textbf{Ian Milligan}, Co-Investigator: William Turkel (Western University). 2013-15.
...
\marginhead{\sffamily {\vskip 1.12em}Editorships}
\bigskip
